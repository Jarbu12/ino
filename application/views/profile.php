    ...
    <hr />
              <img src="<?php echo base_url();?>assets/alumni/<?php echo $hasil['foto'];?>" height="200" width="150" class="img-star" >
                ...
                <div class="container col-sm-8 ">
                  ...
                  <a href="<?php echo site_url('page=profile&act=editprofile');?>" class="btn btn-primary">Edit Profile</a> &nbsp; &nbsp; 
                  <a href="#log" data-toggle="modal" class="btn btn-primary"> Send A private Message</a>
                  <a href="<?php echo site_url('page=kuesioner&act=edit_kuesioner');?>" class="btn btn-danger">Edit Kuesioner </a><hr/><br>
                  ...
                  <span class="icon-laptop"></span>&nbsp;<?php echo $hasil['no_hp'];?> / <?php echo $hasil['bbm'];?><br><br>
                  </div>
                </div>
    ...
    <div class="row">
        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="box box-success">
                ...
                <?php echo form_open('page=profile&act=submitchat');?>
        ...
        <!-- TO DO List -->
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <ul class="todo-list">
                        ...
                        <li>
                            ...
                            <div class="tools">
                                <a href="<?php echo base_url()?>profile/deletetodolist/<?php echo $todo['id'];?>" class="fa fa-trash-o"></a>
                            </div>
                        </li>
                        <?php }?>
                ...
                <div class="box-footer clearfix no-border">
                    <?php echo form_open('page=profile&act=submittodolist');?>
                    <div class="input-group">
    ...
    <div class="modal fade" id="log" tabindex="-1" role="form" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form action="<?php echo site_url('page=profile&act=submitprivatemessage');?>" method="post" id="login" novalidate="novalidate" class="bv-form">
